...
class MyUI{
    createInput(){
        ...
        if(window.param.projectName==='HaiNing'){
            this.setInput({//HaiNing
                'Rpp.position.x':'15.207569513456853',
                'Rpp.position.y':'15.207569513456853',
                'Rpp.position.z':'15.207569513456853',
                'Rpp.scale':'0.0015065277671604841'
              },800,100)
        }else if(window.param.projectName==='KaiLiNan'){
            this.setInput({
                'Rpp.position.x':'24.35273726404087',
                'Rpp.position.y':'24.35274977274192',
                'Rpp.position.z':'24.35274977274192',
                'Rpp.scale':'0.00004002784336784668'
              },800,100)
        ...
        this.setInput({
            'x2':1841,//-450,//-426,//2244,//2240,
            'y2':45,//109,//38,//276,//271,
            'z2':-1535 //3017//101//232
            },//230},
            870,250,//起始位置
            19,1,//标签长度，输入框长度
        )
    ...
    showCameraState(){
        ...
        setInterval(()=>{
            s1.element.innerHTML="px:"+window.c.position.x
            s2.element.innerHTML="py:"+window.c.position.y
            s3.element.innerHTML="pz:"+window.c.position.z
            s4.element.innerHTML="rx:"+window.c.rotation.x
            s5.element.innerHTML="ry:"+window.c.rotation.y
            s6.element.innerHTML="rz:"+window.c.rotation.z
        },800)
    }
    getFloat(name){
            return parseFloat(
