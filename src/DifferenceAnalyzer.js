...
export class DifferenceAnalyzer{
    ...
    eigenvector(mesh,number) {//模型分析时用的工具
        var scope=this;
        if(typeof (number)==="undefined")number=10;
